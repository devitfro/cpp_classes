...
// copy c-tor
Serial::Serial(Serial& original) {
    cout << "Copy c-tor!\n";
    setName(original.name);
    setCountry(original.country);
    setSeasons(original.seasons);
    setRating(original.rating);
    setIsWatched(original.isWatched);
    serialsCount++;
}
...
// Get
int Serial::getSerialsCount() { return serialsCount; }
