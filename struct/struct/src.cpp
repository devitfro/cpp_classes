...
Dyson get_dyson_info() {
    ...
    user_dyson.production_date.year = 2024;
...
Serial get_serial_info() {
    ...
    serial.country = "USA";
    serial.production_date.year = 2005;
    serial.seasons = 9;
...
void print_about_dyson(const Dyson& dyson) {
    ...
    cout << "Production Date: " << dyson.production_date.year << endl;
...
void print_about_cat(const Cat& cat) {
    ...
    cout << "Birthday: " << cat.birthday.year << "-" << cat.birthday.month << "-" << cat.birthday.day << endl;
...
void print_about_serial(const Serial& serial) {
    ...
    cout << "Production Date: " << serial.production_date.year << "year" << endl;
